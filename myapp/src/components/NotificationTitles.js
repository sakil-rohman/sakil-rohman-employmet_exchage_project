    ...
    return (
        <>
                    ...
                    <Col md={3} xs={3} className="side_bar_right">
                        <p className='side_bar_text'>Notification</p>
                        <p className='side_bar_sub_text'>
                        Notification for Registration in Employment Exchanges of Assam
                        </p>
                        <ul>
                        {aboutusstitle.map((aboutustitle, index) => (
                            <li className='side_bar_bullet_color'>
                            <Link to={`/${aboutustitle.id}/notification-view`} onClick={refresh}><p className='side_bar_sub_text'>{aboutustitle.title}</p>
                            </Link> </li>
                        ))}
                        </ul>
                    </Col>
