...
const [title, setTitle] = useState("")
  ...
  const AddAboutUsInfo= async () =>{
    ...
    return (
        ...
        <>
       <div>
        <h1>Add Schemes Us Details</h1>
        <div className='container'>
           
            <div className='form-group'>
                <div className='form-control'>
                  
                    <input type="text" className="form-control form-control-1g" placeholder="Enter Schemes  Title" name= "name" value={title} onChange={(e) => setTitle (e.target.value)} />
                </div>
            </div>
            <div className='form-group'>
                ...
                <div className='form-control'>
                    ...
                    <input type="text" className="form-control form-control-1g" placeholder="Enter Schemes Heading" name= "title" value={heading} onChange={(e) => setHeading (e.target.value)} />
                </div>
            </div>
            <div className='form-group'>
            ...
            <div className='form-group'>
            <button className='btn btn-success' onClick={AddAboutUsInfo}>Add Schemes</button>
            </div>
