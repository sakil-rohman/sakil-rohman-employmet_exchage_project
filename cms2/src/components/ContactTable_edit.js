...
useEffect(() =>{
  ...
  const UpdateContactTableInfo= async () =>{
    ...
    await axios({
        method: 'PUT',
        url: `http://127.0.0.1:8000/api/contacttable/${id}/`,
        data: formField
    }).then((response) =>{
    ...
    return (
       ...
       <div>
        ...
        <div className='container'>
            ...
            <button className='btn btn-success' onClick={UpdateContactTableInfo}>Update Contact Table</button>
...
export default ContactTable_edit