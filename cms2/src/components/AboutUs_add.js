...
const [title, setTitle] = useState("")
  ...
  const AddAboutUsInfo= async () =>{
    ...
    await axios({
        method: 'post',
        url: 'http://127.0.0.1:8000/api/aboutus/',
        data: formField
    }).then((response) =>{
        
        console.log(response.data);
        history('/aboutus-view')
    })
}
        ...
        <div className='container'>
            ...
            <div className='form-group'>
                <div className='form-control'>
                    ...
                    <input type="text" className="form-control form-control-1g" placeholder="Enter About  Title" name= "name" value={title} onChange={(e) => setTitle (e.target.value)} />
                </div>
            </div>
            <div className='form-group'>
                ...
                <div className='form-control'>
                    ...
                    <input type="text" className="form-control form-control-1g" placeholder="Enter About Heading" name= "title" value={heading} onChange={(e) => setHeading (e.target.value)} />
                </div>
            </div>
            <div className='form-group'>
            ...
            <div className='form-group'>
            <button className='btn btn-success' onClick={AddAboutUsInfo}>Add About Us</button>
            </div>
